...
function test_corrinv_treshape(testcase)
    ...
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',23.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',23.5,23.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',16.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',16.5,16.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',16);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',16,16);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',21.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',21.5,21.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',7);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',7,7);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',10.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',10.5,10.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',17);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',17,17);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',21.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',21.5,21.5);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',4);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
    A = anymatrix('corrinv/treshape',4,4);
    anymatrix_check_props(A, 'corrinv/treshape', testcase);
end
