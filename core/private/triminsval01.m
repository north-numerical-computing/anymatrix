...
%   Toeplitz matrix. It is the unique matrix having the smallest singular
%   value over all such matrices.  The smallest singular value is
%   approximately sqrt(5)*phi^(-n), where phi = (1 + sqrt(5))/2 is the
%   golden ratio.
